...
urlpatterns = [
    ...
    path('editar_categoria/<int:categoria_id>/', views.editar_categoria, name='editar_categoria'), # Editar categoria foro
    path('eliminar_categoria/<int:categoria_id>/', views.eliminar_categoria, name='eliminar_categoria'), # Eliminar categoria foro
]